...
module.exports["FIXTURE_PIPED"] = concatStrings(
...
module.exports["FIXTURE_PIPED_WINDOWS"] = concatStrings(
  `--- "src\\GitHubClient.js"      2020-07-26 20:24:35.497737700 +0200`,
  "+++ -   2020-07-26 20:25:43.893994400 +0200",
  "@@ -92,7 +92,7 @@",
  "       return comments;",
...
module.exports["FIXTURE_PIPED_ADO_ITERATION_CHANGES"] = {
  changeEntries: [
    {
      changeTrackingId: 1,
...
module.exports["FIXTURE_PIPED_ADO_PAYLOAD"] = [
  {
    comments: [
      {
        content:
...
module.exports["FIXTURE_PIPED_GH_PAYLOAD"] = {
...
module.exports["FIXTURE_UNIDIFF"] = concatStrings(
...
module.exports["FIXTURE_UNIDIFF_ADO_ITERATION_CHANGES"] = {
  changeEntries: [
    {
      changeTrackingId: 1,
...
module.exports["FIXTURE_UNIDIFF_ADO_PAYLOAD"] = [
  {
    comments: [
      {
        content:
...
module.exports["FIXTURE_UNIDIFF_GH_PAYLOAD"] = {
  accept: "application/vnd.github.comfort-fade-preview+json",
  owner: "tido64",
  repo: "suggestion-bot",
  pull_number: 0,
